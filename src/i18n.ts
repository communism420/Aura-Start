...
const en = {
  ...
  googleDriveAuthorizationExpired: "Google Drive authorization expired or was revoked. Local changes were saved. Reconnect Google Drive to resume sync.",
...
const translations: Record<AuraLanguage, Record<I18nKey, string>> = {
  ...
  ru: {
    ...
    googleDriveAuthorizationExpired: "Авторизация Google Drive истекла или была отозвана. Локальные изменения сохранены. Переподключите Google Drive, чтобы возобновить синхронизацию.",
