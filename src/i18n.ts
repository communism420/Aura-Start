...
const en = {
  ...
  googleDriveBackupDescription: "Export a local backup file and store it in Google Drive yourself. Aura Start never signs in to Google or reads your Drive.",
  googleDriveBackupExport: "Export backup file",
  googleDriveBackupHowItWorks: "How it works",
  googleDriveBackupHowItWorksDescription: "Download a Full Backup JSON file, then upload or move it to Google Drive. To restore, choose that file with Import backup.",
  googleDriveBackupImport: "Import backup",
  googleDriveBackupManual: "Backup and restore happen only when you export or import a file.",
  googleDriveBackupNoAccountAccess: "Aura Start does not sign in to Google and cannot access your Google account.",
  googleDriveBackupNoTracking: "Aura Start does not track, scan, read, edit, or delete files in Google Drive.",
  googleDriveBackupOpenDrive: "Open Google Drive",
  googleDriveBackupOptional: "Google Drive backup is optional; Aura Start works fully without it.",
  googleDriveBackupTitle: "Google Drive Backup",
  delete: "Delete",
...
const translations: Record<AuraLanguage, Record<I18nKey, string>> = {
  ...
  ru: {
    ...
    googleDriveBackupDescription: "Экспортируйте локальный backup-файл и сами сохраните его в Google Drive. Aura Start не входит в Google и не читает ваш Drive.",
    googleDriveBackupExport: "Экспортировать backup-файл",
    googleDriveBackupHowItWorks: "Как это работает",
    googleDriveBackupHowItWorksDescription: "Скачайте Full Backup JSON, затем загрузите или переместите его в Google Drive. Для восстановления выберите этот файл через Import backup.",
    googleDriveBackupImport: "Импортировать backup",
    googleDriveBackupManual: "Backup и восстановление происходят только когда вы сами экспортируете или импортируете файл.",
    googleDriveBackupNoAccountAccess: "Aura Start не входит в Google и не получает доступ к вашему Google-аккаунту.",
    googleDriveBackupNoTracking: "Aura Start не отслеживает, не сканирует, не читает, не изменяет и не удаляет файлы в Google Drive.",
    googleDriveBackupOpenDrive: "Открыть Google Drive",
    googleDriveBackupOptional: "Backup через Google Drive необязателен; Aura Start полностью работает без него.",
    googleDriveBackupTitle: "Google Drive Backup",
    delete: "Удалить",
