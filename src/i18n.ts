...
const en = {
  ...
  googleDriveAccountSignIn: "Connect uses Chrome's Google Account sign-in and Aura Start does not store your Google account identifier.",
  ...
  googleDriveSignInNotConfigured: "Google Drive sign-in is not enabled in this build.",
  googleDriveSignInNotConfiguredDescription: "The published package must include Aura Start's Google OAuth app client in manifest.json. Users will only see Google Account sign-in with the drive.appdata permission.",
...
const translations: Record<AuraLanguage, Record<I18nKey, string>> = {
  ...
  ru: {
    ...
    googleDriveAccountSignIn: "Подключение использует вход в Google-аккаунт через Chrome, а Aura Start не хранит идентификатор вашего Google-аккаунта.",
    ...
    googleDriveSignInNotConfigured: "В этой сборке вход в Google Drive не включён.",
    googleDriveSignInNotConfiguredDescription: "В опубликованный пакет нужно добавить Google OAuth app client Aura Start в manifest.json. Пользователь будет видеть только вход в Google-аккаунт с разрешением drive.appdata.",
