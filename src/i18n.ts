...
const translations: Record<AuraLanguage, Record<I18nKey, string>> = {
  ...
  ru: {
    ...
    commandPalette: "Command Palette",
    commandPaletteShortcutNote: "Ctrl+K/Cmd+K открывает Command Palette, если браузер назначил это сочетание Aura Start. Если оно не работает, проверьте chrome://extensions/shortcuts или используйте эту кнопку.",
