...
const en = {
  ...
  googleDriveOAuthClientIdDescription: "Required for self-built or unpacked installs when the manifest still contains the placeholder client ID. Create a Google OAuth Web application client and add the redirect URL below.",
...
const translations: Record<AuraLanguage, Record<I18nKey, string>> = {
  ...
  ru: {
    ...
    googleDriveOAuthClientId: "Google OAuth Client ID",
    googleDriveOAuthClientIdDescription: "Нужно для self-built или unpacked-установок, если в manifest ещё стоит placeholder client ID. Создайте Google OAuth Web application client и добавьте redirect URL ниже.",
    googleDriveOAuthClientIdPlaceholder: "1234567890-abc.apps.googleusercontent.com",
    googleDriveOAuthRedirectUrl: "OAuth redirect URL",
