...
const en = {
  ...
  googleDriveOAuthClientId: "Google OAuth Client ID",
  googleDriveOAuthClientIdDescription: "Published builds use Aura Start's configured OAuth client. Self-built or unpacked installs can paste a Google OAuth Web application client ID here and add the redirect URL below.",
...
const translations: Record<AuraLanguage, Record<I18nKey, string>> = {
  ...
  ru: {
    ...
    googleDriveOAuthClientId: "Google OAuth Client ID",
    googleDriveOAuthClientIdDescription: "Опубликованные сборки используют настроенный OAuth client Aura Start. Для self-built или unpacked-установок можно вставить Google OAuth Web application client ID здесь и добавить redirect URL ниже.",
    googleDriveOAuthClientIdPlaceholder: "1234567890-abc.apps.googleusercontent.com",
    googleDriveOAuthRedirectUrl: "OAuth redirect URL",
