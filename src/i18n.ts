...
const en = {
  ...
  add: "Add",
  addGroup: "Add group",
  addNestedGroupTo: "Add nested group to {title}",
  addLink: "Add link",
  ...
  commandOpenRestorePoints: "Open Restore Timeline",
  ...
  commandSearchLinksFor: "Search links for \"{query}\"",
  commandSearchLinksForDescription: "Open Aura Start search with this query.",
  commandSaveOpenTabs: "Save open tabs",
  commandSaveOpenTabsDescription: "Preview current window tabs and save them as a new group.",
  ...
  couldNotMoveGroup: "Could not move group.",
  ...
  captureOpenTabs: "Save open tabs",
  captureOpenTabsDescription: "Optional feature. Shows a command for saving current-window tabs; Aura Start asks for tabs permission only when you preview them.",
  csv: "CSV",
  copy: "Copy",
  dark: "Dark",
  dataOwnership: "Data ownership",
  dataOwnershipDescription: "Everything is stored in browser-local extension storage. Export any time before changing browsers or profiles.",
  ...
  deleteGroupAndChildren: "Delete group and nested groups",
  deleteGroupKeepChildren: "Delete group only",
  deleteGroupWithChildrenMessage: "\"{title}\" has {count} nested groups. Choose whether to keep them by moving them up one level or delete them too. Aura Start creates a restore point first.",
  ...
  dragLink: "Drag {title}",
  dropGroupInside: "Drop group inside {title}",
  ...
  group: "Group",
  groupCannotBeItsOwnParent: "A group cannot be nested inside itself.",
  groupDeleted: "Group deleted",
  groupNotFound: "Group was not found.",
  groupWithChildrenCannotBeNested: "Groups with nested groups cannot be moved inside another group.",
  ...
  nestedGroupDepthLimit: "Nested groups support only two levels.",
  ...
  openTabsCaptureDisabled: "Saving open tabs is disabled.",
  openTabsDefaultGroupTitle: "Open tabs",
  openTabsEnableInSettings: "Enable this optional feature in Settings first.",
  openTabsPreviewCount: "{count} tabs will be saved",
  openTabsSaved: "Open tabs saved",
  openTabsSavedMessage: "Saved {count} tabs to \"{title}\".",
  openTabsSkippedSummary: "Skipped: {duplicates} duplicate, {existing} already saved, {skipped} unsupported",
  ...
  restoreContextImportCounts: "{groups} groups and {links} links",
  ...
  restoreReasonBeforeBulkDelete: "before bulk delete",
  restoreReasonBeforeCloudRestore: "before cloud restore",
  restoreReasonBeforeDemoRemove: "before demo cleanup",
  restoreReasonBeforeDelete: "before delete",
  restoreReasonBeforeDuplicateDelete: "before duplicate cleanup",
  restoreReasonBeforeGroupDelete: "before group delete",
  restoreReasonBeforeGroupMove: "before group move",
  restoreReasonBeforeGroupReorder: "before group reorder",
  restoreReasonBeforeImport: "before import",
  restoreReasonBeforeLinkDelete: "before link delete",
  restoreReasonBeforeLinkMove: "before link move",
  restoreReasonBeforeReset: "before reset",
  restoreReasonBeforeRestore: "before restore",
  restoreReasonBeforeTabsSave: "before saving tabs",
  restoreReasonManual: "manual",
  restoreNameBeforeCloudRestore: "Before Google Drive restore",
  restoreNameBeforeDeletingDuplicates: "Before deleting duplicate links",
  restoreNameBeforeDeletingGroup: "Before deleting group \"{title}\"",
  restoreNameBeforeDeletingLink: "Before deleting link \"{title}\"",
  restoreNameBeforeImport: "Before import",
  restoreNameBeforeMovingGroup: "Before moving group \"{title}\"",
  restoreNameBeforeMovingLink: "Before moving link \"{title}\"",
  restoreNameBeforeRemovingDemoData: "Before removing demo data",
  restoreNameBeforeReorderingGroups: "Before reordering groups",
  restoreNameBeforeReset: "Before reset",
  restoreNameBeforeRestore: "Before restore",
  restoreNameBeforeSavingTabs: "Before saving open tabs",
  ...
  restoreTimeline: "Restore Timeline",
  restoreTimelineActionFilter: "Action type",
  restoreTimelineAllActions: "All actions",
  restoreTimelineContextCount: "{count} items",
  restoreTimelineContextFromTo: "{from} -> {to}",
  restoreTimelineDescription: "Search, filter, export, and restore up to {count} local recovery snapshots.",
  restoreTimelineNoMatches: "No timeline entries match the current filters.",
  restoreTimelineSearchPlaceholder: "Search timeline",
  restoreTimelineTotal: "{count} entries",
  save: "Save",
  saveOpenTabs: "Save open tabs",
  saveOpenTabsDescription: "Aura Start can read current-window tab titles and URLs only after you grant the optional tabs permission.",
  saveOpenTabsPermissionNote: "Permission is requested only for this browser feature and is used locally to build the preview.",
  saveTabs: "Tabs",
  saveLink: "Save link",
  saving: "Saving...",
  search: "Search",
  ...
  searchFilter_tag: "Tags",
  searchFilter_title: "Title",
  searchFilter_url: "URL",
  ...
  storageFallbackNotice: "Development fallback storage is active because the extension storage API is unavailable.",
  ...
  moveGroupToTopLevel: "Move group to top level",
  url: "URL",
  ...
  reviewOpenTabs: "Review open tabs",
  noOpenTabsToSave: "No tabs to save",
  noOpenTabsToSaveDescription: "All current-window tabs were duplicates, already saved, unsupported browser pages, or missing URLs.",
  ...
  backgroundPresetCustom: "Custom image",
  backgroundPresetDawn: "Dawn",
  backgroundPresetForest: "Forest",
  backgroundPresetNone: "None",
  backgroundUploadFailed: "Could not load this background image.",
  backgroundUploadImageOnly: "Choose an image file.",
  backgroundUploadTooLarge: "Background image is too large. Choose an image under 2 MB.",
  pause: "Pause",
  pomodoroBreak: "Break",
  ...
  widgetClock: "Clock",
  widgetClockDescription: "Show current time in the header.",
  widgetNotes: "Notes",
  widgetNotesDescription: "Small local Markdown notes.",
  widgetNotesEmpty: "No notes yet.",
  widgetNotesPlaceholder: "# Notes\n- Quick idea\n- Link to check",
  widgetPomodoro: "Pomodoro",
  widgetPomodoroDescription: "Lightweight focus timer.",
  widgets: "Widgets"
};
...
const translations: Record<AuraLanguage, Record<I18nKey, string>> = {
  ...
  ru: {
    ...
    addNestedGroupTo: "Добавить вложенную группу в {title}",
    ...
    backgroundPosition: "Позиция",
    backgroundPresetAurora: "Аврора",
    backgroundPresetCustom: "Свое изображение",
    backgroundPresetDawn: "Рассвет",
    backgroundPresetForest: "Лес",
    backgroundPresetNone: "Нет",
    backgroundUploadFailed: "Не удалось загрузить это фоновое изображение.",
    backgroundUploadImageOnly: "Выберите файл изображения.",
    backgroundUploadTooLarge: "Фоновое изображение слишком большое. Выберите изображение до 2 МБ.",
    cancel: "Отмена",
    ...
    couldNotMoveGroup: "Не удалось переместить группу.",
    ...
    dataOwnershipDescription: "Всё хранится в локальном хранилище расширения браузера. Экспортируйте данные в любой момент перед сменой браузера или профиля.",
    ...
    deleteGroupAndChildren: "Удалить группу и вложенные группы",
    deleteGroupKeepChildren: "Удалить только группу",
    deleteGroupWithChildrenMessage: "В «{title}» есть вложенные группы: {count}. Выберите, поднять их на уровень выше или удалить вместе с группой. Aura Start сначала создаст точку восстановления.",
    ...
    dropGroupInside: "Поместить группу внутрь {title}",
    ...
    group: "Группа",
    groupCannotBeItsOwnParent: "Группу нельзя вложить в саму себя.",
    groupDeleted: "Группа удалена",
    groupNotFound: "Группа не найдена.",
    groupWithChildrenCannotBeNested: "Группы с вложенными группами нельзя перемещать внутрь другой группы.",
    ...
    nestedGroupDepthLimit: "Вложенные группы поддерживают только два уровня.",
    ...
    noOpenTabsToSave: "Нет вкладок для сохранения",
    noOpenTabsToSaveDescription: "Все вкладки текущего окна оказались дубликатами, уже сохранены, являются служебными страницами браузера или не имеют URL.",
    ...
    openTabsCaptureDisabled: "Сохранение открытых вкладок выключено.",
    openTabsDefaultGroupTitle: "Открытые вкладки",
    openTabsEnableInSettings: "Сначала включите эту опциональную функцию в настройках.",
    openTabsPreviewCount: "Будет сохранено вкладок: {count}",
    openTabsSaved: "Открытые вкладки сохранены",
    openTabsSavedMessage: "Сохранено вкладок: {count} в «{title}».",
    openTabsSkippedSummary: "Пропущено: дубликатов {duplicates}, уже сохранено {existing}, неподдерживаемых {skipped}",
    pause: "Пауза",
    pomodoroBreak: "Перерыв",
    pomodoroBreakMinutes: "Минуты перерыва",
    pomodoroFocus: "Фокус",
    pomodoroFocusMinutes: "Минуты фокуса",
    ...
    restoreContextImportCounts: "{groups} групп, {links} ссылок",
    ...
    restoreReasonBeforeBulkDelete: "перед массовым удалением",
    restoreReasonBeforeCloudRestore: "перед восстановлением из облака",
    restoreReasonBeforeDemoRemove: "перед удалением демо",
    restoreReasonBeforeDelete: "перед удалением",
    restoreReasonBeforeDuplicateDelete: "перед удалением дубликатов",
    restoreReasonBeforeGroupDelete: "перед удалением группы",
    restoreReasonBeforeGroupMove: "перед перемещением группы",
    restoreReasonBeforeGroupReorder: "перед сортировкой групп",
    restoreReasonBeforeImport: "перед импортом",
    restoreReasonBeforeLinkDelete: "перед удалением ссылки",
    restoreReasonBeforeLinkMove: "перед перемещением ссылки",
    restoreReasonBeforeReset: "перед сбросом",
    restoreReasonBeforeRestore: "перед восстановлением",
    restoreReasonBeforeTabsSave: "перед сохранением вкладок",
    restoreReasonManual: "вручную",
    restoreNameBeforeCloudRestore: "Перед восстановлением из Google Drive",
    restoreNameBeforeDeletingDuplicates: "Перед удалением дубликатов",
    restoreNameBeforeDeletingGroup: "Перед удалением группы «{title}»",
    restoreNameBeforeDeletingLink: "Перед удалением ссылки «{title}»",
    restoreNameBeforeImport: "Перед импортом",
    restoreNameBeforeMovingGroup: "Перед перемещением группы «{title}»",
    restoreNameBeforeMovingLink: "Перед перемещением ссылки «{title}»",
    restoreNameBeforeRemovingDemoData: "Перед удалением демо-данных",
    restoreNameBeforeReorderingGroups: "Перед изменением порядка групп",
    restoreNameBeforeReset: "Перед сбросом",
    restoreNameBeforeRestore: "Перед восстановлением",
    restoreNameBeforeSavingTabs: "Перед сохранением открытых вкладок",
    ...
    restoreTimeline: "История изменений",
    restoreTimelineActionFilter: "Тип действия",
    restoreTimelineAllActions: "Все действия",
    restoreTimelineContextCount: "{count} объектов",
    restoreTimelineContextFromTo: "{from} -> {to}",
    restoreTimelineDescription: "Поиск, фильтрация, экспорт и восстановление до {count} локальных снимков.",
    restoreTimelineNoMatches: "Под текущие фильтры не подходит ни одна запись истории.",
    restoreTimelineSearchPlaceholder: "Поиск по истории",
    restoreTimelineTotal: "Записей: {count}",
    save: "Сохранить",
    saveOpenTabs: "Сохранить открытые вкладки",
    saveOpenTabsDescription: "Aura Start может прочитать названия и URL вкладок текущего окна только после выдачи опционального разрешения tabs.",
    saveOpenTabsPermissionNote: "Разрешение запрашивается только для этой функции браузера и используется локально для предпросмотра.",
    saveTabs: "Вкладки",
    ...
    searchFilter_tag: "Теги",
    searchFilter_title: "Название",
    searchFilter_url: "URL",
    ...
    storageFallbackNotice: "Активно fallback-хранилище для разработки, потому что API хранилища расширения недоступен.",
    ...
    moveGroupToTopLevel: "Переместить группу на верхний уровень",
    ...
    commandOpenRestorePoints: "Открыть историю изменений",
    ...
    commandSearchLinksFor: "Искать ссылки по запросу «{query}»",
    commandSearchLinksForDescription: "Открывает поиск Aura Start с этим запросом.",
    commandSaveOpenTabs: "Сохранить открытые вкладки",
    commandSaveOpenTabsDescription: "Показывает вкладки текущего окна и сохраняет их новой группой.",
    commandToggleEditMode: "Переключить режим правки",
    commandToggleTheme: "Переключить тему",
    compact: "Компактный",
    captureOpenTabs: "Сохранять открытые вкладки",
    captureOpenTabsDescription: "Опциональная функция. Показывает команду сохранения вкладок текущего окна; Aura Start запрашивает доступ к вкладкам только при предпросмотре.",
    ...
    reviewOpenTabs: "Показать вкладки",
    reset: "Сбросить",
    topLevelGroup: "Группа верхнего уровня",
    validImport: "Корректный импорт: {groups} групп, {links} ссылок.",
    welcomeToAuraStart: "Добро пожаловать в Aura Start",
    widgetClock: "Часы",
    widgetClockDescription: "Показывать текущее время в Header.",
    widgetNotes: "Заметки",
    widgetNotesDescription: "Небольшие локальные Markdown-заметки.",
    widgetNotesEmpty: "Заметок пока нет.",
    widgetNotesPlaceholder: "# Заметки\n- Быстрая идея\n- Ссылка для проверки",
    widgetPomodoro: "Pomodoro",
    widgetPomodoroDescription: "Лёгкий таймер фокуса.",
    widgets: "Виджеты",
  ...
  es: {
    ...
    dataOwnershipDescription: "Todo se guarda en el almacenamiento local de la extensión del navegador. Exporta cuando quieras antes de cambiar de navegador o perfil.",
  ...
  de: {
    ...
    dataOwnershipDescription: "Alles wird lokal im Erweiterungsspeicher des Browsers gespeichert. Exportiere jederzeit, bevor du Browser oder Profile wechselst.",
  ...
  fr: {
    ...
    dataOwnershipDescription: "Tout est stocké localement dans le stockage de l'extension du navigateur. Exportez quand vous voulez avant de changer de navigateur ou de profil.",
  ...
  pt: {
    ...
    dataOwnershipDescription: "Tudo fica armazenado no armazenamento local da extensão do navegador. Exporte a qualquer momento antes de trocar de navegador ou perfil.",
  ...
  uk: {
    ...
    dataOwnershipDescription: "Усе зберігається в локальному сховищі розширення браузера. Експортуйте будь-коли перед зміною браузера або профілю.",
