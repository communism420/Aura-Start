export const translationCompletions: Record<"ru" | "es" | "de" | "fr" | "pt" | "uk", Record<string, string>> = {
  ...
  "es": {
    ...
    "copy": "Copiar",
    "googleDriveGoogleWindow": "Conectar abre la autorización de Google directamente. En navegadores Chromium sin el inicio de sesión integrado de Chrome, Aura Start usa el fallback Web OAuth configurado; no hace falta configurar manualmente el client ID en Aura Start.",
  ...
  "de": {
    ...
    "copy": "Kopieren",
    "googleDriveGoogleWindow": "Connect öffnet die Google-Autorisierung direkt. In Chromium-Browsern ohne integrierte Chrome-Anmeldung verwendet Aura Start den konfigurierten Web-OAuth-Fallback; in Aura Start ist keine manuelle Einrichtung der Client-ID erforderlich.",
  ...
  "fr": {
    ...
    "copy": "Copier",
    "googleDriveGoogleWindow": "Connect ouvre directement l'autorisation Google. Dans les navigateurs Chromium sans connexion Chrome intégrée, Aura Start utilise le fallback Web OAuth configuré; aucune configuration manuelle de l'ID client n'est nécessaire dans Aura Start.",
  ...
  "pt": {
    ...
    "copy": "Copiar",
    "googleDriveGoogleWindow": "O Connect abre a autorização do Google diretamente. Em navegadores Chromium sem login integrado do Chrome, Aura Start usa o fallback Web OAuth configurado; nenhuma configuração manual de ID do cliente é necessária em Aura Start.",
  ...
  "uk": {
    ...
    "copy": "Копіювати",
    "googleDriveGoogleWindow": "Connect безпосередньо відкриває авторизацію Google. У Chromium-браузерах без вбудованого входу Chrome Aura Start використовує налаштований Web OAuth fallback; у Aura Start не потрібно налаштовувати ідентифікатор клієнта вручну.",
