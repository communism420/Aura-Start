export const translationCompletions: Record<"ru" | "es" | "de" | "fr" | "pt" | "uk", Record<string, string>> = {
  ...
  "es": {
    ...
    "copy": "Copiar",
    "googleDriveDeviceAuthCodeLabel": "Código de Google",
    "googleDriveDeviceAuthDescription": "Aura Start abrirá la página de acceso de Google para dispositivos. Si el código no se completa automáticamente, cópielo y péguelo en la página de Google.",
    "googleDriveDeviceAuthExpires": "Caduca a las {time}",
    "googleDriveDeviceAuthInstructions": "Mantenga Aura Start abierto mientras Google confirma el acceso. Aura Start solo solicita acceso a datos de aplicación de Drive para su archivo de sincronización oculto.",
    "googleDriveDeviceAuthOpenGoogle": "Abrir acceso de Google",
    "googleDriveDeviceAuthTitle": "Conectar Google Drive",
    "googleDriveGoogleWindow": "Conectar abre la autorización de Google directamente. En algunos navegadores Chromium Aura Start puede mostrar un código corto de acceso de Google; no hace falta configurar manualmente el client ID en Aura Start.",
  ...
  "de": {
    ...
    "copy": "Kopieren",
    "googleDriveDeviceAuthCodeLabel": "Google-Code",
    "googleDriveDeviceAuthDescription": "Aura Start öffnet Googles Geräte-Anmeldeseite. Wenn der Code nicht automatisch eingetragen wird, kopieren Sie ihn und fügen Sie ihn auf der Google-Seite ein.",
    "googleDriveDeviceAuthExpires": "Läuft um {time} ab",
    "googleDriveDeviceAuthInstructions": "Lassen Sie Aura Start geöffnet, während Google die Anmeldung bestätigt. Aura Start fordert nur Drive-App-Datenzugriff für die versteckte Sync-Datei an.",
    "googleDriveDeviceAuthOpenGoogle": "Google-Anmeldung öffnen",
    "googleDriveDeviceAuthTitle": "Google Drive verbinden",
    "googleDriveGoogleWindow": "Connect öffnet die Google-Autorisierung direkt. In manchen Chromium-Browsern zeigt Aura Start stattdessen einen kurzen Google-Anmeldecode; in Aura Start ist keine manuelle Einrichtung der Client-ID erforderlich.",
  ...
  "fr": {
    ...
    "copy": "Copier",
    "googleDriveDeviceAuthCodeLabel": "Code Google",
    "googleDriveDeviceAuthDescription": "Aura Start ouvrira la page de connexion Google pour appareils. Si le code n'est pas rempli automatiquement, copiez-le et collez-le sur la page Google.",
    "googleDriveDeviceAuthExpires": "Expire à {time}",
    "googleDriveDeviceAuthInstructions": "Gardez Aura Start ouvert pendant que Google confirme la connexion. Aura Start ne demande que l'accès aux données d'application Drive pour son fichier de synchronisation masqué.",
    "googleDriveDeviceAuthOpenGoogle": "Ouvrir la connexion Google",
    "googleDriveDeviceAuthTitle": "Connecter Google Drive",
    "googleDriveGoogleWindow": "Connect ouvre directement l'autorisation Google. Dans certains navigateurs Chromium, Aura Start peut afficher un court code de connexion Google; aucune configuration manuelle de l'ID client n'est nécessaire dans Aura Start.",
  ...
  "pt": {
    ...
    "copy": "Copiar",
    "googleDriveDeviceAuthCodeLabel": "Código do Google",
    "googleDriveDeviceAuthDescription": "Aura Start abrirá a página de login do Google para dispositivos. Se o código não for preenchido automaticamente, copie-o e cole-o na página do Google.",
    "googleDriveDeviceAuthExpires": "Expira às {time}",
    "googleDriveDeviceAuthInstructions": "Mantenha Aura Start aberto enquanto o Google confirma o login. Aura Start solicita apenas acesso aos dados de app do Drive para o arquivo de sincronização oculto.",
    "googleDriveDeviceAuthOpenGoogle": "Abrir login do Google",
    "googleDriveDeviceAuthTitle": "Conectar Google Drive",
    "googleDriveGoogleWindow": "O Connect abre a autorização do Google diretamente. Em alguns navegadores Chromium, Aura Start pode mostrar um código curto de login do Google; nenhuma configuração manual de ID do cliente é necessária em Aura Start.",
  ...
  "uk": {
    ...
    "copy": "Копіювати",
    "googleDriveDeviceAuthCodeLabel": "Код Google",
    "googleDriveDeviceAuthDescription": "Aura Start відкриє сторінку входу Google для пристроїв. Якщо код не заповниться автоматично, скопіюйте його та вставте на сторінці Google.",
    "googleDriveDeviceAuthExpires": "Діє до {time}",
    "googleDriveDeviceAuthInstructions": "Не закривайте Aura Start, доки Google підтверджує вхід. Aura Start запитує лише доступ Drive app data для прихованого sync-файлу.",
    "googleDriveDeviceAuthOpenGoogle": "Відкрити вхід Google",
    "googleDriveDeviceAuthTitle": "Підключити Google Drive",
    "googleDriveGoogleWindow": "Connect безпосередньо відкриває авторизацію Google. У деяких Chromium-браузерах Aura Start може показати короткий код входу Google; у Aura Start не потрібно налаштовувати ідентифікатор клієнта вручну.",
